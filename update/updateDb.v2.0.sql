...
(1,'MP4 Low','ffmpeg -i {$pathFileName} -vf scale=-2:360 -movflags faststart -preset ultrafast -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',10),
...
(7,'MP4 SD','ffmpeg -i {$pathFileName} -vf scale=720:480 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',11),
(8,'MP4 HD','ffmpeg -i {$pathFileName} -vf scale=1280:720 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',12),
...
(11,'MP4 SD','ffmpeg -i {$pathFileName} -vf scale=720:480 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',11),
(12,'MP4 HD','ffmpeg -i {$pathFileName} -vf scale=1280:720 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',12),
...
(15,'MP4 SD','ffmpeg -i {$pathFileName} -vf scale=720:480 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',11),
(16,'MP4 HD','ffmpeg -i {$pathFileName} -vf scale=1280:720 -vcodec h264 -acodec aac  -y {$destinationFile}',now(),now(),'mp4','mp4',12),

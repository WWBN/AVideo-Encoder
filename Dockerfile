...
RUN apt-get install -y --no-install-recommends \
    ...
    pip3 install -U $PIP_BREAK_FLAG yt-dlp && \
    (pip3 install -U $PIP_BREAK_FLAG curl_cffi || true) && \
    rm -rf /var/www/html/*

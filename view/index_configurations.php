            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted"><?php echo __('Lower numbers are processed first.'); ?></small>
                    </div>

                    <div class="form-group">
                        <label for="autodelete"><input type="checkbox" id="autodelete" value="1" <?php if (!empty($ad)) { ?>checked="true"<?php } ?> /> <?php echo __('Auto remove'); ?></label>
                        <br><small class="text-muted"><?php echo __('Will remove queue and the files when the encoder process is done'); ?></small>
                    </div>
                </div>
            </div>

            <button class="btn btn-success btn-block" id="saveConfig"><i class="fas fa-save"></i> <?php echo __('Save'); ?></button>
        </div>
